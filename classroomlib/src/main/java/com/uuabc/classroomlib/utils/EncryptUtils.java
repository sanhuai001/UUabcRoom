...
public final class EncryptUtils {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return base64Encode(encryptDES(data, getDesKey(key)));
    }
    ...
    public static String encryptDES2HexString(byte[] data, byte[] key) {
        return bytes2HexString(encryptDES(data, getDesKey(key)));
    }
    ...
    public static byte[] encryptDES(byte[] data, byte[] key) {
        return desTemplate(data, getDesKey(key), DES_Algorithm, DES_Transformation, true);
    }
     ...
     * @return Base64密文字符串
     */
    public static String encryptDES2Base64String(String data, String key) {
        byte[] result = encryptDES(data.getBytes(), getDesKey(key.getBytes()));
        return EncodeUtils.base64Encode2String(result);
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(base64Decode(data), getDesKey(key));
    }
     ...
     * @return 明文
     */
    public static String decryptBase64DES(String data, String key) {
        byte[] result = decryptDES(base64Decode(data.getBytes()), getDesKey(key.getBytes()));
    ...
    public static byte[] decryptHexStringDES(String data, byte[] key) {
        return decryptDES(hexString2Bytes(data), getDesKey(key));
    }
    ...
    public static byte[] decryptDES(byte[] data, byte[] key) {
        return desTemplate(data, getDesKey(key), DES_Algorithm, DES_Transformation, false);
    }
     ...
     * @return 8字节秘钥
     */
    private static byte[] getDesKey(byte[] key) {
        byte[] realKey = new byte[8];
        System.arraycopy(key, 0, realKey, 0, 8);
        return realKey;
    }
...
//            byte[] enCodeFormat = secretKey.getEncoded();
    ...
    private static byte[] tohash256Deal(byte[] key) {
        try {

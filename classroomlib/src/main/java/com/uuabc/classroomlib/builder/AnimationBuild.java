...
public class AnimationBuild {
    ...
    public static final String translationY = "translationY";//位移Y轴
    public static final String translationX = "translationX";//位移X轴
    public static final String rotationX = "rotationX";//X轴旋转
    public static final String rotationY = "rotationY";//Y轴旋转
    public static final String rotation = "rotation";//普通旋转
    public static final String scaleX = "scaleX";//缩放X轴
    public static final String scaleY = "scaleY";//缩放Y轴
    ...
    public static final class PropertyAnimationBuilder {
        ...
        public PropertyAnimationBuilder setRepeatCount(int value) {
            animator.setRepeatCount(value);
            return this;
        }

        public PropertyAnimationBuilder setRepeatMode(int value) {

...
public class ClassInDialog extends BaseDialog {
    ...
    public ClassInDialog setData(RoomInResult result) {
    ...
    public ClassInDialog setData(OneToOneRoomInResult result) {
        tvMyName.setText(context.getResources().getString(R.string.dialog_room_tips_name_str, SPUtils.getInstance().getString(RoomConstant.USER_NAME)));

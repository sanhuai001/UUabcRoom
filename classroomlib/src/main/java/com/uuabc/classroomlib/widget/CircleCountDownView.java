...
public class CircleCountDownView extends View {
    ...
    private int mProgessTextColor;//文字颜色
    private int mCountdownTime;//倒计时的值
    private float mCurrentProgress;//倒计时的进度
    ...
    public CircleCountDownView(Context context, @Nullable AttributeSet attrs) {
        ...
        mRingColor = a.getColor(R.styleable.CircleCountDownView_ringColor, context.getResources().getColor(R.color.red));
        mRingWidth = a.getFloat(R.styleable.CircleCountDownView_ringWidth, 40);
//        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CircleCountDownView_progressTextSize, (int) .sp2px(context, 20f));
//        mProgessTextColor = a.getColor(R.styleable.CircleCountDownView_progressTextColor, context.getResources().getColor(R.color.color_a01));
        mCountdownTime = a.getInteger(R.styleable.CircleCountDownView_countdownTime, 0);
        a.recycle();
